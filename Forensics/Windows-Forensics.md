...
* [trustedsec/DitExplorer - Tool for viewing NTDS.dit](https://github.com/trustedsec/DitExplorer)
...
* [akiraaisha/usbtracker - Quick & dirty coded incident response and forensics python script to track USB devices events and artifacts in a Windows OS (Vista and later)](https://github.com/akiraaisha/usbtracker)
