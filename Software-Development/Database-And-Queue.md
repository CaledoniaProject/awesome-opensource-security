...
* [delta-io/delta - An open-source storage framework that enables building a Lakehouse architecture with compute engines including Spark, PrestoDB, Flink, Trino, and Hive and APIs](https://github.com/delta-io/delta)
...
* [Restore table from .frm and .ibd file - undrop使用起来很复杂，undrop-for-innodb仓库里没有对应的说明](https://stackoverflow.com/questions/75090681/restore-table-from-frm-and-ibd-file)
