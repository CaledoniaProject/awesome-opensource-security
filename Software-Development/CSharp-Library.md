...
* [djhohnstein/WireTap - .NET 4.0 Project to interact with video, audio and keyboard hardware](https://github.com/djhohnstein/WireTap)
...
* [boh/RedCsharp - Collection of useful CSharp Tools for assessments](https://github.com/boh/RedCsharp)
...
* [volexity/donut-decryptor - Retrieve inner payloads from Donut samples](https://github.com/volexity/donut-decryptor)
...
* [gist: An example on how to decode Active Directory's User-Parameters attribute](https://gist.github.com/kappa7194/30473a6261e34a518bf5433702bde041)
...
* [GhostPack/Lockless - Lockless allows for the copying of locked files - 这个方案比VSS简单，但是代码里面是内存读写，应该无法处理大文件，需要修改一下；搜索handle的代码可以参考](https://github.com/GhostPack/Lockless)
