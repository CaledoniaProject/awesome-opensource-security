...
* [itaymigdal/awesome-injection - Centralized resource for listing and organizing known injection techniques and POCs](https://github.com/itaymigdal/awesome-injection)
...
* [gist: PowerShell script to enumerate all Process and Thread tokens](https://gist.github.com/vector-sec/a049bf12da619d9af8f9c7dbd28d3b56)
...
* [alphaSeclab/injection-stuff - PE Injection、DLL Injection、Process Injection、Thread Injection、Code Injection、Shellcode Injection、ELF Injection、Dylib Injection, including 400+Tools and 350+posts](https://github.com/alphaSeclab/injection-stuff)
...
* [kernelm0de/ProcessHider - Hide Process From Task Manager using Usermode API Hooking](https://github.com/kernelm0de/ProcessHider)
* [wyrover/subhook - a super-simple hooking library for C and C++ that works on Windows, Linux and macOS. It supports x86 only (32-bit and 64-bit)](https://github.com/wyrover/subhook)
...
* [m417z/thread-call-stack-scanner - Safely manage the unloading of DLLs that have been hooked into a process.](https://github.com/m417z/thread-call-stack-scanner)
...
* [bediger4000/userlandexec - userland exec for Linux x86_64](https://github.com/bediger4000/userlandexec)
...
* [rentzsch/mach_inject - interprocess code injection for Mac OS X](https://github.com/rentzsch/mach_inject)
...
* [Print3M/DllShimmer - Weaponize DLL hijacking easily. Backdoor any function in any DLL](https://github.com/Print3M/DllShimmer)
...
* [gist: Looks for threads that were created as a result of code injection](https://gist.github.com/jaredcatkinson/23905d34537ce4b5b1818c3e6405c1d2)
...
* [Friends-Security/RedirectThread - Playing around with Thread Context Hijacking. Building more evasive primitives to use as alternative for existing process injection techniques](https://github.com/Friends-Security/RedirectThread)
...
* [NtQuerySystemInformation/NlsCodeInjectionThroughRegistry - Dll injection through code page id modification in registry. Based on jonas lykk research - 先修改注册表CodePage里的DLL路径，然后调用SetThreadLocale触发加载](https://web.archive.org/web/20230726150544/https://github.com/NtQuerySystemInformation/NlsCodeInjectionThroughRegistry)
...
* [0xDivyanshu-new/Injector - Complete Arsenal of Memory injection and other techniques for red-teaming in Windows](https://github.com/0xDivyanshu-new/Injector)
...
* [DanielRTeixeira/injectAllTheThings - Seven different DLL injection techniques in one single project](https://github.com/DanielRTeixeira/injectAllTheThings)
...
* [dismantl/ImprovedReflectiveDLLInjection - It uses bootstrap shellcode (x86 or x64) to allow calling any export of the DLL from the reflective loader](https://github.com/dismantl/ImprovedReflectiveDLLInjection)
...
* [0xPrimo/KMDllInjector -  a kernel-mode based DLL injector. The driver can be configured with DllInjectorClient.exe to use either PsSetLoadImageNotifyRoutine or PsSetCreateProcessNotifyRoutineEx to register a kernel callback](https://github.com/0xPrimo/KMDllInjector)
