...
* [CodingGay/BlackDex - an Android unpack(dexdump) tool, it supports Android 5.0~12 and need not rely to any environment. BlackDex can run on any Android mobile phone or emulator, you can unpack APK File in several seconds](https://github.com/CodingGay/BlackDex)
...
* [vaibhavpandeyvpz/apkstudio - Open-source, cross platform Qt based IDE for reverse-engineering Android application packages](https://github.com/vaibhavpandeyvpz/apkstudio)
