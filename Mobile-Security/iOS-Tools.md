...
* [Hsn723/MMeTokenDecrypt - Decrypts and extracts iCloud and MMe authorization tokens on Apple macOS / OS X](https://github.com/Hsn723/MMeTokenDecrypt)

Instrumentation

* [programlife.net: 未越狱iOS设备通过Xcode修改GPS定位信息，通过增加location.gpx配置文件来模拟 - 检测可以用CLLocation的isProducedByAccessory/isSimulatedBySoftware函数来做](https://programlife.net/2021/05/30/ios-device-gps-location-emulation/)
...
* [malmeloo/FindMy.py - Query Apple's FindMy Network with Python!](https://github.com/malmeloo/FindMy.py)
