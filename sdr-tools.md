...
* [pgorczak/srslte-docker-emulated - Minimal end-to-end LTE. Dockerized and emulated radio over shared memory](https://github.com/pgorczak/srslte-docker-emulated)
* [DSheirer/sdrtrunk - A cross-platform java application for decoding, monitoring, recording and streaming trunked mobile and related radio protocols using Software Defined Radios (SDR)](https://github.com/DSheirer/sdrtrunk)
