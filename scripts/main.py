...
class ListsManager:
    ...
    def dump_data_minimized(self):
        ...
        # Create a mapping from URL to latest categories from markdown files
        url_to_categories = {item['url']: item['categories'] for item in parsed_data}
        ...
        for item in filtered_data:
            ...
            categories = url_to_categories.get(item['url'], [])
            ...
            # Get Chinese comment for this URL
            chinese_comment = url_to_comment.get(item['url'], "")
