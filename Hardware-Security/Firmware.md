...
* [gist: emumipsel.sh - qemu + MIPS内核，模拟启动固件；一般而言，启动后还得修复各种问题。提前编译好的内核，是从debian一个服务器上下载的](https://gist.github.com/CaledoniaProject/63de05140a96b595cee02b1ce03f24e2)
