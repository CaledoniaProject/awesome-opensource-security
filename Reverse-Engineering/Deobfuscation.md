...
* [LockBlock-dev/pkg-unpacker - Unpack any pkg application - 处理nodejs pkg单包可执行程序](https://github.com/LockBlock-dev/pkg-unpacker)
...
* [EasyToYou is a IonCube decoder](https://easytoyou.eu/)
...
* [aliyun/aliyun-psdeobfuscator - a PowerShell deobfuscation tool that utilizes C# function hooking techniques](https://github.com/aliyun/aliyun-psdeobfuscator)
